<?php 
	...
	while($registro = $resultados->fetch_array()){
		...
		$consulta = "insert into datos_facturacion values (null,'".$registro['facturacion_institucion']."','".$registro['facturacion_localidad']."','".$registro['facturacion_domicilio']."','".$registro['facturacion_telefono']."',$cond_iva,'".$registro['facturacion_cuil']."',null,null,null)";
		//si la consulta se ejecuto con exito, obtengo el id insertado
		if( $conexion->query($consulta)){
